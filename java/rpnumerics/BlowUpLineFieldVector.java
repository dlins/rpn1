...
public class BlowUpLineFieldVector extends RealVector {
    ...
    public RealVector getFamilyVector() {
        return familyVector_;
    }
...
//        df = flux_.DF(P);
        ...
        WaveState inputP = new WaveState(new PhasePoint(P));
        flux_.jet(inputP, output, 1);
        ...
        } else if (lambdaDir_ == RPNUMERICS.INCREASING_LAMBDA) {
