...
public class ManifoldOrbit extends RPnCurve implements RpSolution {
    ...
    public ManifoldSensitivity sensitivity() {
        ...
        RealMatrix2 F = new RealMatrix2(RPNUMERICS.flow().fluxDeriv(x_Stationary));
        F.invert();
        F.negate();
        RealVector G = new RealVector(((ConservationShockFlow)RPNUMERICS.flow()).fluxDerivSigma(x_Stationary));
...
//    }
    ...
    protected RealVector sensitivityFunction(RealVector x, RealVector sens, int k) {
        ...
        RealVector G = new RealVector(((ConservationShockFlow)RPNUMERICS.flow()).fluxDerivSigma(x));
