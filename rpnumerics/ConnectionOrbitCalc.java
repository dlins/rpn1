...
public class ConnectionOrbitCalc implements RpCalculation {
    ...
    public ConnectionOrbitCalc(ManifoldOrbit manifoldOrbitA, ManifoldOrbit manifoldOrbitB) {
      ...
      if (manifoldOrbitA==null) System.out.println("A eh nulo");
      if (manifoldOrbitB==null) System.out.println("B eh nulo");
    ...
    public RpSolution recalc() throws RpException {
        ...
        StationaryPointCalc statPointCalcA = new StationaryPointCalc(manifoldOrbitA_.getStationaryPoint().getPoint());
        ...
        ManifoldOrbitCalc manifoldCalcA = new ManifoldOrbitCalc(statPointA, firstPointA, manifoldOrbitA_.getTimeDirection());
        ...
        StationaryPointCalc statPointCalcB = new StationaryPointCalc(manifoldOrbitB_.getStationaryPoint().getPoint());
        ...
        ManifoldOrbitCalc manifoldCalcB = new ManifoldOrbitCalc(statPointB, firstPointB, manifoldOrbitB_.getTimeDirection());
        manifoldOrbitB_ = (ManifoldOrbit)manifoldCalcB.calc();
        ConnectionOrbitCalc newCalc = new ConnectionOrbitCalc(manifoldOrbitA_, manifoldOrbitB_);
        return newCalc.calc();
    }
    ...
    public void connectionIterationStep() {
        ...
        double sigma = ((ConservationShockFlow)RPNUMERICS.flow()).getSigma() + dsigma;
        ...
        try {
            ...
            StationaryPointCalc calcA = new StationaryPointCalc(new PhasePoint(tmp));
            stationaryPointA = (StationaryPoint)calcA.calc();
            tmp.set(x_StationaryB);
            Xp_StationaryB.scale(dsigma);
            tmp.add(Xp_StationaryB);
            StationaryPointCalc calcB = new StationaryPointCalc(new PhasePoint(tmp));
        ...
        try {
            ManifoldOrbitCalc calcManA = new ManifoldOrbitCalc(stationaryPointA,
