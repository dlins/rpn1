...
int Quad2FluxFunction::F(const WaveState & x, JetMatrix &y)const{
...
int Quad2FluxFunction::DF(const WaveState & x, JetMatrix &y)const{
    double a1, b1, c1, d1, e1, a2, b2, c2, d2, e2;
...
int Quad2FluxFunction::D2F(const WaveState & x, JetMatrix &y)const {
