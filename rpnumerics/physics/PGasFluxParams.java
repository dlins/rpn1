...
public class PGasFluxParams extends FluxParams {
    //
    // Constants
    //
    ...
    // Constructors
    //
    public PGasFluxParams(PGasFluxParams copy) {
        super(copy);
    }

    public PGasFluxParams() {
        this(new RealVector(DEFAULT_FLUX_PARAMS),0);
    }

    public PGasFluxParams(RealVector params,int index) {
    ...
    // Accessors/Mutators
    //
    public FluxParams defaultParams() { return new PGasFluxParams(); }
