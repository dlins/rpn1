...
public abstract class QuadNDFluxParams extends FluxParams {
    //
    // Constants
    //
    int m_;
    ...
    // Constructors
    //
    protected QuadNDFluxParams(QuadNDFluxParams copy) {
        super(copy);
    }

    protected QuadNDFluxParams(String ID, int m, double[] A, double[] [] B, double[] [] [] C,int index) {
