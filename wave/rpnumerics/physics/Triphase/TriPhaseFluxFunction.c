...
void viscosity(double bal[2][2], double U[], double params[], double perm[], double capil_params[], double visc_params[]) {
    ...
    a00 = bal[0][0]*capillarity_jacobian[0][0] + bal[0][1]*capillarity_jacobian[1][0];
    a01 = bal[0][0]*capillarity_jacobian[0][1] + bal[0][1]*capillarity_jacobian[1][1];
    a10 = bal[1][0]*capillarity_jacobian[0][0] + bal[1][1]*capillarity_jacobian[1][0];
    a11 = bal[1][0]*capillarity_jacobian[0][1] + bal[1][1]*capillarity_jacobian[1][1];
    bal[0][0] = a00;
    bal[0][1] = a01;
    bal[1][0] = a10;
    bal[1][1] = a11;   
