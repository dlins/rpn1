...
class RangeViolation2 : public exception { };
...
private:
	...
	friend inline istream &operator>>(istream &is, Vector2 &vector);
	friend inline ostream &operator<<(ostream &os, const Vector2 &vector);
	friend class Matrix2;	// for row() and column()
};
...
inline istream &operator>>(istream &is, Vector2 &vector);
...
inline istream &
operator>>(istream &is, Vector2 &vector)
{
...
inline ostream &
operator<<(ostream &os, const Vector2 &vector)
{
...
private:
	...
	friend inline istream &operator>>(istream &is, Matrix2 &matrix);
	friend inline ostream &operator<<(ostream &os, const Matrix2 &matrix);
};
...
inline istream &operator>>(istream &is, Matrix2 &matrix);
inline ostream &operator<<(ostream &os, const Matrix2 &matrix);
...
inline istream &
operator>>(istream &is, Matrix2 &matrix)
{
...
inline ostream &
operator<<(ostream &os, const Matrix2 &matrix)
{
...
private:
	...
	friend inline ostream &operator<<(ostream &os, const FactorMatrix2 &F);
};
...
inline ostream &operator<<(ostream &os, const FactorMatrix2 &F);
...
inline ostream &
operator<<(ostream &os, const FactorMatrix2 &F)
{
	os << F.inverse;
	return os;
}
