    ...
    if (degree >= 0){
        ...
        if (degree >= 1){ 
           ...
           if (degree == 2){
               ...
               double ld2ko_dsw2  = ko_jet.get(0, 0, 0)/muw; // d2kw_dsw2  = kw_jet.get(0, 0, 0)
               double ld2ko_dswso = ko_jet.get(0, 0, 1)/muw; // d2kw_dswso = kw_jet.get(0, 0, 1)
               double ld2ko_dso2  = ko_jet.get(0, 1, 1)/muw; // d2kw_dso2  = kw_jet.get(0, 1, 1)

               double ld2kg_dsw2  = kg_jet.get(0, 0, 0)/mug - kg_jet.get(0, 0)*mug_jet.get(0, 0)/mug; // d2kg_dsw2/mug -    ldkg_dsw*dmugdsw/mug ;
               double ld2kg_dswso = kg_jet.get(0, 0, 1)/mug - ldkg_dsw*mug_jet.get(0, 1)/mug ;
               double ld2kg_dso2  = ko_jet.get(0, 1, 1)/mug - ldkg_dso*mug_jet.get(0, 1)/mug ;
