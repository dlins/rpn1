...
//
void JetTester2D::populate_F(void *obj, int (*f)(void *obj, const RealVector &state, int degree, JetMatrix &jm),
    ...
    for (int i0 = 0; i0 < fine_subdivision[0]; i0++){
        ...
        for (int i1 = 0; i1 < fine_subdivision[1]; i1++){
            ...
            (*f)(obj, point, 1, jm);
            fine_F(i0, i1)  = jm.function();
            fine_JF(i0, i1) = jm.Jacobian();
        }
    }
...
//void JetTester2D::coarse_F(const MultiArray<RealVector> &fine_F, const MultiArray<DoubleMatrix> &fine_JF,
//                         int step,
...
void JetTester2D::populate_JF(void *obj, int (*f)(void *obj, const RealVector &state, int degree, JetMatrix &jm),
                              const RealVector &pmin, const RealVector &pmax,
...
//void JetTester2D::numerical_Jacobian(const MultiArray<RealVector>    &F, 
...
////                    double dev2 = std::abs((F(i0, i1 + 1)(m) - F(i0, i1 - 1)(m))*inv_2_delta[2] - JF(i0, i1)(m, 2));
...
//                    }
// 
////                    dev[0] = std::abs((F(i0 + intdelta, i1/**/)(m) - F(i0 - intdelta, i1/**/)(m))*inv_2_delta[0] - JF(i0, i1/**/)(m, 0));
////                    dev[1] = std::abs((F(i0, i1 + intdelta/**/)(m) - F(i0, i1 - intdelta/**/)(m))*inv_2_delta[1] - JF(i0, i1/**/)(m, 1));
////                    dev[2] = std::abs((F(i0, i1 + 1)(m) - F(i0, i1 - 1)(m))*inv_2_delta[2] - JF(i0, i1)(m, 2));
...
//                    max_abs_F = std::max(max_abs_F, F(i0, i1/**/)(m));
//                }
...
void JetTester2D::numerical_Hessian(const MultiArray<DoubleMatrix>               &JF, 
    ...
    for (int component = 0; component < rows; component++){
        for (int i0 = 1; i0 < range[0] - 1; i0++){ // The cycle step here and below should be powers of 2. The cycle's beginnig and end should take this into account.
            for (int i1 = 1; i1 < range[1] - 1; i1++){
                    ...
                    dev(0, 0) = std::abs((JF(i0 + 1, i1)(component, 0) - JF(i0 - 1, i1)(component, 0))*inv_2_delta[0] - HF(i0, i1)[component](0, 0));
                    dev(0, 1) = std::abs((JF(i0 + 1, i1)(component, 1) - JF(i0 - 1, i1)(component, 1))*inv_2_delta[0] - HF(i0, i1)[component](0, 1));

                    dev(1, 0) = std::abs((JF(i0, i1 + 1)(component, 0) - JF(i0, i1 - 1)(component, 0))*inv_2_delta[1] - HF(i0, i1)[component](1, 0));
                    dev(1, 1) = std::abs((JF(i0, i1 + 1)(component, 1) - JF(i0, i1 - 1)(component, 1))*inv_2_delta[1] - HF(i0, i1)[component](1, 1));
...
//void JetTester2D::test(void *obj, int (*f)(void *obj, const RealVector &state, int degree, JetMatrix &jm), 
