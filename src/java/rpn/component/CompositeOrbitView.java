...
public class CompositeOrbitView implements GeomObjView {
    ...
    public CompositeOrbitView(CompositeGeom abstractGeom,
    ...
    public void update() {
        ...
        CompositeGeom doubleContactGeom = (CompositeGeom) abstractGeom_;
