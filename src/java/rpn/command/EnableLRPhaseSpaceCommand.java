...
public class EnableLRPhaseSpaceCommand extends RpModelPlotCommand implements Observer {
    //
    // Constants
    //
    ...
    // Members
    //
    private static EnableLRPhaseSpaceCommand instance_ = null;
    private List<RpGeometry> selectedList_;

    //
    // Constructors
    //
    protected EnableLRPhaseSpaceCommand() {
//        super(DESC_TEXT);
    ...
    static public EnableLRPhaseSpaceCommand instance() {
        if (instance_ == null) {
            instance_ = new EnableLRPhaseSpaceCommand();
        }
        return instance_;
    }
