...
public class DerivativeDiscriminantLevelCurvePlotCommand extends RpModelPlotCommand {
    //
    // Constants
    //

    static public final String DESC_TEXT = "Derivative Discriminant Level";
    //
    // Members
    //
    static private DerivativeDiscriminantLevelCurvePlotCommand instance_ = null;

    //
    // Constructors/Initializers
    //
    protected DerivativeDiscriminantLevelCurvePlotCommand() {
    ...
    static public DerivativeDiscriminantLevelCurvePlotCommand instance() {
        if (instance_ == null) {
            instance_ = new DerivativeDiscriminantLevelCurvePlotCommand();
        }
        return instance_;
    }
