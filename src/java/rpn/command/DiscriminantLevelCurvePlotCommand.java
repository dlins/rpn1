...
public class DiscriminantLevelCurvePlotCommand extends RpModelPlotCommand {
    //
    // Constants
    //

    static public final String DESC_TEXT = "Discriminant Level";
    //
    // Members
    //
    static private DiscriminantLevelCurvePlotCommand instance_ = null;

    //
    // Constructors/Initializers
    //
    protected DiscriminantLevelCurvePlotCommand() {
    ...
    static public DiscriminantLevelCurvePlotCommand instance() {
        if (instance_ == null) {
            instance_ = new DiscriminantLevelCurvePlotCommand();
        }
        return instance_;
    }
    ...
    public void execute() {
        ...
        Double level = new Double(RPNUMERICS.getParamValue("discriminantlevelcurve", "u"));
        LevelCurveGeomFactory factory = new LevelCurveGeomFactory(RPNUMERICS.createDiscriminantLevelCurveCalc(level));
