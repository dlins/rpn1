...
public class RarefactionCurve extends RPnCurve {
  public RarefactionCurve(List segList) {
    super(coordsArrayFromRealSegments(segList),new ViewingAttr(Color.white));
  }
  ...
  public int findClosestSegment(RealVector targetPoint,double alpha){return 0;}


  public RPnCurve cut() {return null;}
  public RPnCurve concat(RPnCurve curve){return null;}
