...
public class TriPhaseParams extends FluxParams {
    //
    // Constants
    //
    ...
    // Constructors
    //
    public TriPhaseParams() {
        this(new RealVector(DEFAULT_FLUX_PARAMS),0);
    }

    public TriPhaseParams(TriPhaseParams copy) {
        super(copy);
    }

    public TriPhaseParams(RealVector params,int index) {
    ...
    // Accessors/Mutators
    //
    public FluxParams defaultParams() { return new TriPhaseParams(); }
