...
int main(){
    ...
    tc = new Thermodynamics_Common(mc, mw, "./c++/rpnumerics/physics/tpcw/hsigmaC_spline.txt");
    tc->set_flash(flash);

    // Thermodynamics_SuperCO2_WaterAdimensionalized
    th = new Thermodynamics_SuperCO2_WaterAdimensionalized(std::string("./c++/rpnumerics/physics/tpcw/"), 
                                                           Thermodynamics_Common::T_typical(), 
                                                           Thermodynamics_Common::Rho_typical(), 
                                                           Thermodynamics_Common::U_typical());
