...
//            if (wavecurve.wavecurve[i].type == COMPOSITE_CURVE){
//                std::cout << "Halfprofile. Composite " << i << std::endl;
//                for (int j = 0; j < wavecurve.wavecurve[i].curve.size(); j++){
//                    std::cout << "    j = " << j << ", back curve = " << wavecurve.wavecurve[i].back_curve_pointer[j] << std::endl;
//                }
//            }
//        }
...
//            speed.push_back(wavecurve.reference_point.e[family].r);
        ...
        std::cout << "Next point: " << current_curve.back_pointer[point] << std::endl;
        point = current_curve.back_pointer[point];

        std::cout << "Next curve: " << current_curve.back_curve_pointer[point] << std::endl;
        curve = current_curve.back_curve_pointer[point];
    }
