...
TPCW_Evap_Extension::TPCW_Evap_Extension(const Flux2Comp2PhasesAdimensionalized *f, const Coincidence *c) : Extension(), flux_(f), coincidence(c) {
...
TPCW_Evap_Extension::~TPCW_Evap_Extension(){
}

int TPCW_Evap_Extension::extension(const RealVector &p, RealVector &ext_p){
    double fe, se;
