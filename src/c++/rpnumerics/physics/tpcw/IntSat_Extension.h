#ifndef _INTSAT_EXTENSION_
#define _INTSAT_EXTENSION_
...
//
class IntSat_Extension : public Extension {
    private:
    protected:
    ...
    public:
        IntSat_Extension(const Flux2Comp2PhasesAdimensionalized *f);
        virtual ~IntSat_Extension();
