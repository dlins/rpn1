...
CoincidenceTPCW::CoincidenceTPCW(Thermodynamics_SuperCO2_WaterAdimensionalized *t, FracFlow2PhasesHorizontalAdimensionalized *f, double phi_){
    td = t;
    fh = f;
    phi = phi_;
}
...
double CoincidenceTPCW::lambdas_function(const RealVector &u){
    ...
    fh->Diff_FracFlow2PhasesHorizontalAdimensionalized(sw, Theta, 1, m);
