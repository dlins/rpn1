...
CompositeCurveTPCW::CompositeCurveTPCW(const AccumulationFunction *a, 
                                       const FluxFunction *f, 
                                       const Boundary *b, 
                                       ShockCurve *s, 
                                       Explicit_Bifurcation_Curves *ebc, 
                                       TPCW_Evap_Extension *ee,
                                       TPCW_IntSat_Extension *ii) : 
                                       CompositeCurve(a,f, b, s, ebc), 
                                       evapextension(ee),
                                       intsatextension(ii) {
}
...
//        TestTools::pause("Composite using EvapExtension");
        ...
        for (int i = rarsize - 1; i >= 0; i--){
            ...
            intsatextension->extension(rarcurve.curve[i], ext_p);
...
//        TestTools::pause("Classical Composite");
