...
//    cout<<"Dentro de clone reduced hugoniot"<<endl;
...
// {
//
//    cout<<"Dentro do construtor de copia"<<endl;
//    // Create the auxiliary objects
//
//    ReducedTPCWFluxAdimensionalized = copy.ReducedTPCWFluxAdimensionalized->clone();
//
//    ReducedTPCWAccumAdimensionalized = copy.ReducedTPCWAccumAdimensionalized->clone();
//
//    TPCWFluxAdimensionalized = copy.TPCWFluxAdimensionalized->clone();
//
//    TPCWAccumAdimensionalized = copy.TPCWAccumAdimensionalized->clone();
//
//    Uref = copy.Uref;
//
//    n=Uref.size();
