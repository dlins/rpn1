...
TPCW_IntSat_Extension::TPCW_IntSat_Extension(const Flux2Comp2PhasesAdimensionalized *f) : Extension(), flux_(f) {
...
TPCW_IntSat_Extension::~TPCW_IntSat_Extension(){
}

int TPCW_IntSat_Extension::extension(const RealVector &p, RealVector &ext_p){
