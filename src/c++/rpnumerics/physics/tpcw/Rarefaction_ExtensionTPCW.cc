...
void Rarefaction_ExtensionTPCW::extension_curve(const FluxFunction *curve_flux,         const AccumulationFunction *curve_accum,
                                                ...
                                                const FluxFunction *domain_reduced_flux, const AccumulationFunction *domain_reduced_accum,
