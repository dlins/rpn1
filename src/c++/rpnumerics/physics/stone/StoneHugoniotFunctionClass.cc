...
StoneHugoniotFunctionClass::StoneHugoniotFunctionClass(const RealVector &U, const StoneFluxFunction & stoneFluxFunction) : stone(new StoneFluxFunction(stoneFluxFunction)) {
