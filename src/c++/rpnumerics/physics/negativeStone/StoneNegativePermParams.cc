...
StoneNegativePermParams::StoneNegativePermParams(double expw, double expg, double expo,
...
StoneNegativePermParams::StoneNegativePermParams(const RealVector & permVector) : comp(new RealVector(20)) {
...
StoneNegativePermParams::StoneNegativePermParams() : comp(new RealVector(20)) {
    reset();

}

StoneNegativePermParams::StoneNegativePermParams(const StoneNegativePermParams & copy) : comp(new RealVector(copy.params())) {
}

StoneNegativePermParams::~StoneNegativePermParams() {
    delete comp;
}

void StoneNegativePermParams::reset() {
...
double StoneNegativePermParams::component(int i) {
