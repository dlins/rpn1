...
/* OK */
Stone_Explicit_Bifurcation_Curves::Stone_Explicit_Bifurcation_Curves(StoneFluxFunction *ff) : Three_Phase_Flow_Explicit_Bifurcation_Curves((FluxFunction*)ff), f(ff){
}
