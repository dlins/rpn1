...
Inflection_Curve::Inflection_Curve(const FluxFunction *f, const AccumulationFunction *a, Boundary *b,
    ...
    cout << "Min" << boundary_->minimums()<<endl;
    cout << "Max" << boundary_->maximums()<<endl;
    cout << "Type" << boundary_->boundaryType() << endl;
...
int Inflection_Curve::curve(int fam, std::vector<RealVector> &inflection_curve) {
    ...
    cout<<"Here"<<endl;
    cout << "Min em curve" << boundary_->minimums();
    cout << "Max em curve" << boundary_->maximums();
    cout << "Type em curve" << boundary_->boundaryType() << endl;

    int info = ContourMethod::contour2d(this, boundary_, rect, number_of_cells, inflection_curve);
