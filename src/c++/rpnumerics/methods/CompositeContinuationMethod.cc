...
//    int type = _SIMPLE_ACCUMULATION_;
//    double  out ; //TODO REMOVE ;
//
//    int info_flux = contRarefactionFlow.flux(n, indx, fluxFunction,accumulationFunction,type,in,lambda, rev,&out); // Declared in jetrarefaction.h   int info_flux = flux(n, indx, cmp_flux_object, in, &lambda, rev);
//    U[2 * n] = *lambda;
...
//            contRarefactionFlow.flux(n, indx,fluxFunction,accumulationFunction, rar_in, &lambda_u, rar_ref);
//
//            double p = 0;
