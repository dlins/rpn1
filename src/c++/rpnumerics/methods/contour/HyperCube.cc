...
void HyperCube::Eval_dimf(int *dimFACE) {
    ...
    int i, j;
    int n = 5;
    int m = 6; // Increasing the matrix means incresing these values.
...
int HyperCube::mkedge(int *edges_, int dime_, int *smpedg_, int *solptr_, int *fnbr_, int nsimp_, int nsface_) {
