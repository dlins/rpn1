...
//
//
//    Eigenvalue_Contour ec(& RpNumerics::getPhysics().fluxFunction(), & RpNumerics::getPhysics().accumulation(),
//            boundary->minimums(), boundary->maximums(),
//            cells, boundary);
//
//
//
//    ec.set_level_from_point(family,realVectorInput);
//
