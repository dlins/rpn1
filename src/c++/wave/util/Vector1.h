...
class RangeViolation1 : public exception { };
...
private:
	...
	friend inline istream &operator>>(istream &is, Vector1 &vector);
	friend inline ostream &operator<<(ostream &os, const Vector1 &vector);
	friend class Matrix1;	// for row() and column()
};
...
inline istream &operator>>(istream &is, Vector1 &vector);
inline ostream &operator<<(ostream &os, const Vector1 &vector);
...
inline istream &
operator>>(istream &is, Vector1 &vector)
{
	is >> vector.v1;
	return is;
}
...
inline ostream &
operator<<(ostream &os, const Vector1 &vector)
{
	os << vector.v1;
	return os;
}
...
private:
	...
	friend inline istream &operator>>(istream &is, Matrix1 &matrix);
	friend inline ostream &operator<<(ostream &os, const Matrix1 &matrix);
};
...
inline istream &operator>>(istream &is, Matrix1 &matrix);
inline ostream &operator<<(ostream &os, const Matrix1 &matrix);
...
inline istream &
operator>>(istream &is, Matrix1 &matrix)
{
	is >> matrix.e11;
	return is;
}
...
inline ostream &
operator<<(ostream &os, const Matrix1 &matrix)
{
	os << matrix.e11 << "\n";
	return os;
}
...
private:
	...
	friend inline ostream &operator<<(ostream &os, const FactorMatrix1 &F);
};
...
inline ostream &operator<<(ostream &os, const FactorMatrix1 &F);
...
inline ostream &
operator<<(ostream &os, const FactorMatrix1 &F)
{
	os << F.inverse;
	return os;
}
