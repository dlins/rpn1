...
public class OrbitGeomFactory extends RpCalcBasedGeomFactory {
    ...
    public String toXML() {
        ...
        str.append("<ORBITCALC timedirection=\"" + timedir +"\""+" initialpoint=\""+ ((OrbitCalc)rpCalc()).getStart()+"\"" +" calcready=\"" + rpn.parser.RPnDataModule.RESULTS + "\"" + " methodname=\"" + rpCalc().getCalcMethodName() +"\""+  ">\n");
