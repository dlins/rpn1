...
public abstract class MultiGeometryImpl implements MultiGeometry {
    ...
    // Accessors/Mutators
    //
    public Space getSpace() { return path_.getSpace(); }

    public BoundingBox getBoundary() { return path_.getBoundary(); }

    public AbstractPathIterator getPathIterator() { return path_.getPathIterator(); }

    public AbstractPathIterator getPathIterator(Map map) throws DimMismatchEx { return path_.getPathIterator(map); }

    public ViewingAttr viewingAttr() { return viewAttr_; }

    //
    // Methods
    //
    public void load(FileReader cin) { path_.load(cin); }

    public void print(FileWriter cout) { path_.print(cout); }
