        ...
        public static double [] parserEingenVal (String data){
           ...
           public void actionPerformed(ActionEvent e) {
               ...
               if (e.getActionCommand().equals("endStatPoint")) {
                   try {
//                       PhasePoint initialPoint = new PhasePoint(RPnDataModule.
//                               InputHandler.
//                               tempVector_);

                       PhasePoint initialPoint = new PhasePoint(RPnDataModule.
                               InputHandler.tempPoint_);
                      ...
                      StationaryPointParser.statPoint = new StationaryPoint(
                       ...
                       StationaryPointGeomFactory factory = new
                               StationaryPointGeomFactory(new
                               StationaryPointCalc(initialPoint));
                       plotStatPoint=true;
                       if (StationaryPointParser.plotStatPoint)
                           RPnDataModule.PHASESPACE.join(new StationaryPointGeom(new
                                   CoordsArray(
